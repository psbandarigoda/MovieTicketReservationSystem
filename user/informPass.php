...
<body>
    ...
    <div id="updateform">
    <form class="update" action="updateMemberPass.php" method="post">
        <label for="psw">
        ...
        <input type="password" placeholder="If you want Change Password, Enter New Password" name="npsw">

        <label for="npsw-repeat">
            <b>Repeat Password</b>
        </label>
        <input type="password" placeholder="If you want Change Password, Repeat Password" name="npsw-repeat">

        <button type="submit">Update</button>
        <button type="button" onclick="document.getElementById('login').style.display='none'" class="cancelbtn"><a href="inform.php">Cancel</a></button>
    </form>
    </div>
    <br/>
